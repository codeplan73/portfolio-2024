...
const skillCategories: SkillCategory[] = [
  {
    ...
    skills: [
      ...
      { name: "Tailwind CSS", proficiency: "Expert" },
      { name: "JavaScript", proficiency: "Expert" },
      { name: "Shadcn UI", proficiency: "Proficient" },
      { name: "Redux Toolkit / Zustand", proficiency: "Proficient" },
      { name: "TanStack Query", proficiency: "Proficient" },
      { name: "Framer Motion", proficiency: "Proficient" },
    ],
  },
  {
  ...
  },
  {
    ...
    skills: [
      { name: "AI/ML API Integration", proficiency: "Proficient" },
      { name: "Sanity CMS", proficiency: "Proficient" },
      { name: "Paystack", proficiency: "Proficient" },
